...
@UseTestDataFrom("src/main/resources/testData/openBankingAPI/DirectDebitAccounts.csv")
@FixMethodOrder(MethodSorters.NAME_ASCENDING)

public class GetDirectDebitAccounts extends membershipOBANTestBase {
    int count = 0;
    int maxTries = 2;
    String statusCode;
    String userId;
    ...
    String payload = new String(Files.readAllBytes(Paths.get("src/main/resources/apiRequest/openBankingAPI/DirectDebitAccounts.json")));
    CommonFunctions comm = new CommonFunctions();

    public GetDirectDebitAccounts() throws IOException {
