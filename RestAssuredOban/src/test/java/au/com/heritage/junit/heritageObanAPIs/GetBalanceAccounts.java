...
@UseTestDataFrom("src/main/resources/testData/openBankingAPI/BalancesAccounts.csv")
@FixMethodOrder(MethodSorters.NAME_ASCENDING)

public class GetBalanceAccounts extends membershipOBANTestBase {
    int count = 0;
    int maxTries = 2;
    String statusCode;
    String userId;
    ...
    String payload = new String(Files.readAllBytes(Paths.get("src/main/resources/apiRequest/openBankingAPI/BalancesAccounts.json")));
    CommonFunctions comm = new CommonFunctions();

    public GetBalanceAccounts() throws IOException {
