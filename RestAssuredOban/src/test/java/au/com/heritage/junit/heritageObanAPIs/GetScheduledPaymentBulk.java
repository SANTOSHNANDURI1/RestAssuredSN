...
@UseTestDataFrom("src/main/resources/testData/openBankingAPI/ScheduledPaymentsBulk.csv")
@FixMethodOrder(MethodSorters.NAME_ASCENDING)

public class GetScheduledPaymentBulk extends membershipOBANTestBase{
    int count = 0;
    int maxTries = 2;
    String statusCode;
    String userId;
    ...
    String payload = new String(Files.readAllBytes(Paths.get("src/main/resources/apiRequest/openBankingAPI/ScheduledPaymentBulk.json")));
    CommonFunctions comm = new CommonFunctions();

    public GetScheduledPaymentBulk() throws IOException {
